...
# Generated on 2026-02-25T13:47:18.046387300Z (UTC)
# =============================================================
...
def compute(billing_document,material):
    ...
    Output: ri.foundry.main.dataset.4b1945c3-b9d6-4073-b15d-676b97260b8c
...
result = compute(billing_document,material)

# Run data quality checks
result = validate_transform(result)

# Write result to Delta table
result.write.format("delta").mode("overwrite").saveAsTable("ri.foundry.main.dataset.4b1945c3-b9d6-4073-b15d-676b97260b8c")
