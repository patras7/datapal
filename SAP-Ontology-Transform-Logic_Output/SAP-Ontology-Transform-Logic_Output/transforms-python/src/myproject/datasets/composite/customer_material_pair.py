...
# Generated on 2026-02-27T10:50:36.418756500Z (UTC)
# =============================================================
...
def compute(customer,material,billing_document):
    ...
    Output: ri.foundry.main.dataset.f17c2ffd-f444-4691-a43c-ca87b008b644
    ...
    customer_material_pair = (
        ...
        .withColumn(
            'primary_key',
            F.concat_ws('_||_', F.col("mandt_kunnr_|_foreign_key_KNA1"), F.col("mandt_matnr_|_foreign_key_MARA")))
        )
        .withColumn(
    ...
    return customer_material_pair
    
customer_material_pair_output = compute(customer,material,billing_document)
# Run data quality checks
result = validate_transform(customer_material_pair_output)

# Write result to Delta table

result.write.format("delta").mode("overwrite").saveAsTable("ri.foundry.main.dataset.f17c2ffd-f444-4691-a43c-ca87b008b644")
