...
# Generated on 2026-02-25T13:47:18.622437300Z (UTC)
# =============================================================
...
def compute(material, billing_document):
    ...
    Output: ri.foundry.main.dataset.a924b066-b68a-434b-a539-5494a4f72f18
...
result.write.format("delta").mode("overwrite").saveAsTable("ri.foundry.main.dataset.a924b066-b68a-434b-a539-5494a4f72f18")
