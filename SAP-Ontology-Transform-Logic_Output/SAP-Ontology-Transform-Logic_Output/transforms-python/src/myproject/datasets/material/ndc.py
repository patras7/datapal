...
def compute(material,billing_document):
    ...
    Output: /Cardinal Health/ph-core-ontology-sap/data/ontology/ndc
...
ndc = compute(material,billing_document)
# Run data quality checks
result = validate_transform(ndc)

# Write result to Delta table

result.write.format("delta").mode("overwrite").saveAsTable("/Cardinal Health/ph-core-ontology-sap/data/ontology/ndc")
