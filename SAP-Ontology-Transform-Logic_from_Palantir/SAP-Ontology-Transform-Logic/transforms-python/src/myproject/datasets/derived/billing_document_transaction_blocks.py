...
@transform(
    relative_size_txn_block_output=Output("ri.foundry.main.dataset.3fdd6cbc-305b-446b-8873-a8e2db8c5655"),
    absolute_size_txn_block_output=Output("ri.foundry.main.dataset.4ea0fec4-e5c8-4bd0-9257-173ccdbda9ec"),
    billing_document_df=Input("ri.foundry.main.dataset.78905dc3-ec76-4ca1-b497-cb2f8a02ba03"),
)
def get_billing_document_txn_blocks(relative_size_txn_block_output, absolute_size_txn_block_output, billing_document_df):
    total_sales_value = (
        billing_document_df.dataframe()
    ...
    absolute_size_txn_block_output.write_dataframe(absolute_txn_block_df)
