...
@transform_df(
    ...
    customer_account=Input("ri.foundry.main.dataset.1559cda9-175c-4853-afe8-6b087f46f39e"),
    vendor=Input("ri.foundry.main.dataset.0c6ae379-81f7-4385-b251-aa56bf65e126"),
    warehouse=Input("ri.foundry.main.dataset.f639e8e1-f6f3-4e4a-9cb1-998692be2e9e"),
...
def compute(billing_document, customer, customer_account, vendor, warehouse, material):
    ...
    return select_cols(billing_document)
