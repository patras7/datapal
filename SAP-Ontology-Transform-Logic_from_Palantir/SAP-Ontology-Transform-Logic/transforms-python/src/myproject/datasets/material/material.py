...
@transform_df(
    Output(
        "ri.foundry.main.dataset.9d75b88e-db81-44e3-9772-51d73994b54b",
        checks=[
            Check(
    ...
    mara=Input("ri.foundry.main.dataset.34e811fd-c8f6-44fd-b4b9-8b2b9bb069e4"),
    billing_document=Input("ri.foundry.main.dataset.1b3a46f2-8c30-4c50-a15d-ebb6945a1e72"),
)
def get_material_enriched_df(ctx, material, mara, billing_document):
